...
baseline_char_embed_bert_enc | models.py | Baseline with character embedding, dropout (__0.2__) leaving BERT encoder dropout to 0.1 `--drop_prob 0.3` and BERT-encoder `--hidden_size 256` enstead of RNN-encoder| drop out too high? | save/train/baseline_char_embed_bert_enc-06/best.pth.tar |07.80 | 33.37 | 33.37| 33.36 | 06.32 | 52.19 | 52.19 | 52.14|
