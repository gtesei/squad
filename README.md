...
baseline_char_embed_bert_enc | models.py | Baseline with character embedding, dropout (__0.3__) leaving BERT encoder dropout to 0.1 `--drop_prob 0.3` and BERT-encoder `--hidden_size 256` enstead of RNN-encoder|   | save/train/baseline_char_embed_bert_enc-20/best.pth.tar |01.44 | 80.66 | 73.53|88.42 | 03.19| 60.03 | 56.86 | 66.85|
